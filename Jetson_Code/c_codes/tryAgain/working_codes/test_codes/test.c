...
int main() {
  ...
  // 1753697223.106069068,155,8,07 97 CD 54 5D D8 00 6E,07 97 CD 54 5D D8 00 6E
    CANFrame frame1 = {0x155, 8, {0x07, 0x97, 0xCD, 0x54, 0x5D, 0xD8, 0x00, 0x6E}};
    
//    CANFrame frame1 = {0x155, 8, {0x07, 0x97, 0xCA, 0x54, 0x4C, 0xD0, 0x00, 0x6C}};
    
    // Frame 2: Drive Status (0x59B) 
  // 1753697223.052126329,59B,8,20 00 64 00 40 14 00 90,20 00 64 00 40 14 00 90
//    CANFrame frame2 = {0x59B, 8, {0x80, 0x00, 0x64, 0x00, 0x40, 0x6c, 0x00, 0x90}};
    
    CANFrame frame2 = {0x59B, 8, {0x80, 0x00, 0x64, 0x00, 0x40, 0x14, 0x00, 0x90}};
    // Frame 3: Vehicle Data 1 (0x599) - Range and Display Speed
  //1753354106.400151417,599,8,00 00 0D B1 FF 20 00 00,00 00 0D B1 FF 20 00 00
    CANFrame frame3 = {0x599, 8, {0x00, 0x00, 0x0D, 0xB1, 0xFF, 0x20, 0x00, 0x00}};
  // 
//    CANFrame frame3 = {0x599, 8, {0x00, 0x00, 0x0D, 0xAC, 0xFF, 0x10, 0x00, 0x00}};
    
    // Frame 4: Vehicle Data 2 (0x5D7) - PRIMARY Speed + Odometer
  // ,5D7,7,00 00 00 55 94 10 00,00 00 00 55 94 10 00
  // 1753354129.096455527,5D7,7,00 00 00 55 94 10 00,00 00 00 55 94 10 00
    CANFrame frame4 = {0x5D7, 7, {0x00, 0x00, 0x00, 0x55, 0x94, 0x10, 0x00}};
